/* =====================================================
   ...
   - Does NOT modify core details-panel.js logic
   - Translates only UI labels inside the rendered details panel
   - Integrates with assets/js/language.js ("aiml-lang" + language-changed event)
   - Listens to "details-rendered" (emitted by details-panel.js)
===================================================== */
(() => {
  const LS_LANG = "aiml-lang";

  // Option B: keep AIML branding titles in English; translate labels only.
  const MAP = {
    en: {
  ...
  function applyTranslations(root) {
    ...
    // Replace exact matches only (safe)
