...
test("AFC cross-provider aliases collapse Neftchi/Air Force duplicate and preserve lineage", () => {
  const espn = row({
    canonicalId: "cid_afcchampions_neftchifergana_airforce_20260914",
    source: "espn",
    sourceId: "401912664",
    kickoffUtc: "2026-09-14T13:45:00.000Z",
    homeTeam: "Neftchi Fergana",
    awayTeam: "Air Force Club"
  });
  const flashscore = row({
    canonicalId: "cid_afcchampions_neftchifargonauzb_alquwaaljawiyairq_20260914",
    source: "flashscore",
    sourceId: "riNKwxy1",
    kickoffUtc: "2026-09-14T13:45:00.000Z",
    homeTeam: "Neftchi Fargona (Uzb)",
    awayTeam: "Al Quwa Al Jawiya (Irq)"
  });
  ...
  assert.equal(kept.matchId, espn.canonicalId);
...
test("AFC cross-provider aliases collapse Shabab Al-Ahli/Tractor duplicate and preserve lineage", () => {
  const espn = row({
    canonicalId: "cid_afcchampions_shababalahli_traktorsazi_20260914",
    source: "espn",
    sourceId: "401912673",
    kickoffUtc: "2026-09-14T16:00:00.000Z",
    homeTeam: "Shabab Al-Ahli",
    awayTeam: "Traktor Sazi FC"
  });
  const flashscore = row({
    canonicalId: "cid_afcchampions_shababalahlidubaiuae_tractorirn_20260914",
    source: "flashscore",
    sourceId: "rBDEaJcK",
    kickoffUtc: "2026-09-14T16:00:00.000Z",
    homeTeam: "Shabab Al-Ahli Dubai (Uae)",
    awayTeam: "Tractor (Irn)"
  });
