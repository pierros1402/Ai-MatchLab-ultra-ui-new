...
const seedWavePath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-official-domain-seed-wave-start-700-2026-06-16","whole-map-high-volume-official-domain-seed-wave-start-700-2026-06-16.json");
const outputPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-official-domain-seed-accepted-canonical-plan-start-700-2026-06-16","whole-map-high-volume-official-domain-seed-accepted-canonical-plan-start-700-2026-06-16.json");
...
check(checks,"sourceAcceptedQualityCountOne",Number(seedWave.summary?.acceptedQualityGateCompetitionCount??0)===1,{actual:seedWave.summary?.acceptedQualityGateCompetitionCount});
check(checks,"acceptedBoardRowsOne",acceptedBoardRows.length===1,{actual:acceptedBoardRows.length});
check(checks,"acceptedQualityPlansOne",acceptedQualityPlans.length===1,{actual:acceptedQualityPlans.length});
check(checks,"candidateRowsTwelve",candidateRows.length===12,{actual:candidateRows.length});
...
const output={
  output:outputPath,
  job:"build-football-truth-whole-map-high-volume-official-domain-seed-accepted-canonical-plan-start-700-file",
