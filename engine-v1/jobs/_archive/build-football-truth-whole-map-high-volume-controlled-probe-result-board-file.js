...
const probePath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-controlled-probe-wave-2026-06-16","whole-map-high-volume-controlled-probe-wave-2026-06-16.json");
...
const outputPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-controlled-probe-result-board-2026-06-16","whole-map-high-volume-controlled-probe-result-board-2026-06-16.json");
...
check(checks,"strongOrWeakBestRowsNine", strongOrWeakRows.length===9, {actual:strongOrWeakRows.length});
...
const output={
  output:outputPath,
  job:"build-football-truth-whole-map-high-volume-controlled-probe-result-board-file",
