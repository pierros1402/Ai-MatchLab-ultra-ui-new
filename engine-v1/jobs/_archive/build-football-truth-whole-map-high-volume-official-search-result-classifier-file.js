...
const searchWavePath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-official-search-wave-2026-06-16","whole-map-high-volume-official-search-wave-2026-06-16.json");
...
const outputPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-official-search-result-classifier-2026-06-16","whole-map-high-volume-official-search-result-classifier-2026-06-16.json");
...
check(checks,"sourceSearchQueriesThreeOhEight",Number(searchWave.json.summary?.searchExecutedNowCount??0)===308,{actual:searchWave.json.summary?.searchExecutedNowCount});
...
const output={
  output:outputPath,
  job:"build-football-truth-whole-map-high-volume-official-search-result-classifier-file",
