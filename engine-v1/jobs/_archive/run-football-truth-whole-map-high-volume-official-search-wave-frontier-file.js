...
const packPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-consolidated-status-and-official-search-pack-frontier-2026-06-17","whole-map-high-volume-consolidated-status-and-official-search-pack-frontier-2026-06-17.json");
const runnerPath = path.join("engine-v1","jobs","run-fixture-league-date-autonomous-search-batches-file.js");
const outputDir = path.join("data","football-truth","_diagnostics","whole-map-high-volume-official-search-wave-frontier-2026-06-17");
...
const outputPath = path.join(outputDir,"whole-map-high-volume-official-search-wave-frontier-2026-06-17.json");
...
check(checks,"sourcePackTargetsAtLeastForty",Number(pack.summary?.officialSearchTargetCount??0)>=40,{actual:pack.summary?.officialSearchTargetCount});
check(checks,"targetsAtLeastTwoHundredFifty",targets.length>=250,{actual:targets.length});
...
if(preflightBlockedCount || !allowExecute || !allowSearch){
  ...
  const output={
    output:outputPath,
    job:"run-football-truth-whole-map-high-volume-official-search-wave-frontier-file",
