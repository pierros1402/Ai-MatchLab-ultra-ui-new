...
const wavePath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-unresolved-bulk-followup-wave-2026-06-16","whole-map-high-volume-unresolved-bulk-followup-wave-2026-06-16.json");
...
const outputPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-unresolved-followup-result-extractor-2026-06-16","whole-map-high-volume-unresolved-followup-result-extractor-2026-06-16.json");
...
check(checks,"bestRowsTwentyOne",bestRows.length===21,{actual:bestRows.length});
check(checks,"strongRowsTwo",bestRows.filter(r=>r.bestFollowupStatus==="accepted_followup_strong_signal_requires_parser").length===2,{actual:bestRows.filter(r=>r.bestFollowupStatus==="accepted_followup_strong_signal_requires_parser").length});
...
check(checks,"boardRowsTwentyOne",boardRows.length===21,{actual:boardRows.length});
...
const output={
  output:outputPath,
  job:"build-football-truth-whole-map-high-volume-unresolved-followup-result-extractor-file",
