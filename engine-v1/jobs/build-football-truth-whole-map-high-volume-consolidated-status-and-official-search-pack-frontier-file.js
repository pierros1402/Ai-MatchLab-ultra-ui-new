...
const probeResultBoardPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-controlled-probe-result-board-next-execution-2026-06-16","whole-map-high-volume-controlled-probe-result-board-next-execution-2026-06-16.json");
...
const unresolvedExtractorPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-unresolved-followup-result-extractor-next-execution-2026-06-16","whole-map-high-volume-unresolved-followup-result-extractor-next-execution-2026-06-16.json");
const outputPath = path.join("data","football-truth","_diagnostics","whole-map-high-volume-consolidated-status-and-official-search-pack-frontier-2026-06-17","whole-map-high-volume-consolidated-status-and-official-search-pack-frontier-2026-06-17.json");
...
const output={
  output:outputPath,
  job:"build-football-truth-whole-map-high-volume-consolidated-status-and-official-search-pack-frontier-file",
