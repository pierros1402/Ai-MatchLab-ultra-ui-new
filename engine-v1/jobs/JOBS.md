...
- `--inventory <path>`: output from `build-football-truth-state-inventory-file.js`
- `--workset <path>` or `--easy-first <path>`: output from `build-football-truth-season-state-easy-first-workset-file.js`
...
- `needs_ft_repair_first`
- `needs_standings_or_history_backfill`
- `ready_for_final_or_offseason_verification`
