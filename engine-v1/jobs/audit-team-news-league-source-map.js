...
function candidateQualitySignals(candidate = {}) {
  ...
  return {
    ...
    nonFootballBusinessNoise: /\b(yarns?|fibers?|fibres?|brochure|polymer|industrial|manufacturing|compliance|sustainability report|bank|banking|finance|saving|atm|branch(?:es)?|tadawul|capital|profits?|sme|economic forecasts?|saudi national bank|snb|alahli online|alahli tadawul|alahliecorp)\b/i.test(haystack),
